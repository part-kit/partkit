 ...
 */
import { RateLimitError } from "./internal/errors.js";
import { defaultIdentify, FALLBACK_KEY } from "./internal/key.js";
import { MemoryStore } from "./internal/memory-store.js";
import type {
  RateLimitConfig,
  RateLimitOpts,
  RateLimitResult,
...
import { validateRule } from "./internal/validate.js";

export { RateLimitError } from "./internal/errors.js";
export type { RateLimitErrorCode } from "./internal/errors.js";
export type {
  RateLimitConfig,
  RateLimitOpts,
  RateLimitResult,
