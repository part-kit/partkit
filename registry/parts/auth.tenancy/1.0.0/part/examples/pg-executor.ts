 ...
 * (e.g. src/db/tenancy-executor.ts) and edit freely. It is not attested.
 *
 * After copying, change the import to your alias (seams.md §1):
 *   import type { SqlExecutor } from "@parts/auth.tenancy";
 *
...
/**
 * Wrap your pool once and pass the result to `tenancy(db)`. Hand in a pooled
 * client mid-transaction to make a membership change commit in the same
