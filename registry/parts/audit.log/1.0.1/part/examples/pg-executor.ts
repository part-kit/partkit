 ...
 * (e.g. src/db/audit-executor.ts) and edit freely. It is not attested.
 *
 * After copying, change the import to your alias (seams.md §1):
 *   import type { SqlExecutor } from "@parts/audit.log";
 *
...
/**
 * Wrap your pool once and pass the result to `auditLog(db)`. Hand in a pooled
 * client mid-transaction to record an event in the same transaction as the
